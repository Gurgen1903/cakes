...
<div class="insert_baby_title">
    ...
    <h3>Insert Gala Cakes</h3>
</div>
<div class="form_gala_cakes">
    <form action="<?=base_url('admin/add_gala_cake')?>" method="POST" enctype="multipart/form-data" style="">
        <input type="text" name="name" placeholder="name">
        <input type="text" name="price" placeholder="price">
        <input type="text" name="weight" placeholder="weight">
        <input type="text" name="description" placeholder="description">
        <input type="file" name="userfile">
        <input type="submit" name="insert_gala_cakes_btn">
    </form>
</div>
<div class="all_gala_cakes">

    <?php foreach ($gala_cake as $data):?>
        <div class="hits_of_product_box " data-id="<?=$data['id']?>">
            <div class="delete_phone_numbers">
                <a href="<?=base_url()?>admin/delete_gala_cake_by_id/<?=$data['id']?>"></a>
            </div>
